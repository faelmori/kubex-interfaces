...
func NewDatabaseAuthentication(name string) DatabaseAuthentication {
	kbAuth := &KubexAuthentication{
		Username:     "",
		Password:     "",
		ClientId:     "",
		ClientSecret: "",
	...
	kbCfgBase := NewKubexConfigBase(name)
	certs := NewKubexCertificate(name)
...
func NewDatabaseVolume() DatabaseVolume {
...
type KubexDatabase struct {
	...
	BasicData ConfigBase `json:"basic_data_config,omitempty" yaml:"basic_data_config,omitempty" gorm:"basic_data_config"` // Basic configuration fields
	// KubexDatabase connection configuration
	Connection DatabaseConnection `json:"connection,omitempty" yaml:"connection,omitempty" gorm:"connection"` // KubexDatabase connection configuration
	// Username for database authentication
	Authentication DatabaseAuthentication `json:"authentication,omitempty" yaml:"authentication,omitempty" gorm:"authentication"` // Username for database authentication
	// Certificate configuration for the database
	Certificates Certificate `json:"certificates,omitempty" yaml:"certificates,omitempty" gorm:"certificates"` // Certificate configuration for the database
}
